            ...
            <div class="col-md-8">
                <div class="row">
                    <div class="col-md-12" style="text-align:center">
                        ...
                        <span><a href="/pages/citytemplate/{{$city->id}}/{{$category->id}}" style="color:white; text-decoration: none;">&nbsp {{ $category->categoryname }} &nbsp</a></span>
                    @endforeach
                                    ...
                                    <div class="caption card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-12" style="text-align:center">
                                                <a class="btn btn-info" href="/pages/tourdetails/{{$tour->id}}">View This Tour</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
